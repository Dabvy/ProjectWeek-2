...
<body>
  ...
  <div class="container">
    <div class="product-image">
        <img src="../images/deGriezelbus.jpg" width="350px" height="500px">
    </div>

    <div class="product-info">
      <h1>De Griezelbus</h1>
      <p class="description">
    Rik en zijn vrienden reizen met de mysterieuze Griezelbus, 
    ...
    <div class="rating">
          ★★★★☆ <span style="color: #f0f0f0f0; font-size: 0.9rem;">(4.6 / 5)</span>
      </div>
  </div>
