...
<body>
  ...
  <div class="container">
    <div class="product-image">
        <img src="../images/theDaVinciCode.jpg" width="350px" height="500px">
    </div>

    <div class="product-info">
      <h1>The Da Vinci Code</h1>
      <p class="description">
    Robert Langdon, een professor in symboliek, 
    onderzoekt de mysterieuze moord op een curator van het Louvre. 
