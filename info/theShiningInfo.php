...
<body>
  ...
  <div class="container">
    <div class="product-image">
        <img src="../images/theShining.jpg" width="350px" height="500px">
    </div>

    <div class="product-info">
      <h1>The Shining</h1>
      <p class="description">
    Jack Torrance verhuist met zijn gezin naar het afgelegen Overlook Hotel om daar als winterbeheerder te werken. 
    ...
    <a href="beschikbaarheid.php">
      <button>Bekijk Beschikbaarheid</button>
        ...
        <div class="rating">
          ★★★★☆ <span style="color: #f0f0f0f0; font-size: 0.9rem;">(4.3 / 5)</span>
      </div>
  </div>
  </div>
