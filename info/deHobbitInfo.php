...
<body>
  ...
  <div class="container">
    <div class="product-image">
        <img src="../images/deHobbit.jpg" width="350px" height="500px">
    </div>

    <div class="product-info">
      <h1>De Hobbit</h1>
      <p class="description">
    Bilbo Balings, een rustige hobbit, 
    wordt meegesleurd op een avontuur met dertien dwergen om een schat te heroveren van de draak Smaug. 
