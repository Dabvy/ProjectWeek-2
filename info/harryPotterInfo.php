...
<body>
  ...
  <div class="container">
    <div class="product-image">
        <img src="../images/harryPotter.jpg" width="350px" height="500px">
    </div>

    <div class="product-info">
      <h1>Harry Potter</h1>
      <p class="description">
    Harry ontdekt op zijn 11e dat hij een tovenaar is en gaat naar Zweinstein. 
    Daar maakt hij vrienden, 
